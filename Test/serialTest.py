...
class NavTest():
    ...
    def __init__(self):
        ...
        locations['1'] = Pose(Point(5.231466974099478, -1.2799998372793189, 0),
                              Quaternion(0, 0, -0.7071067811865476, -0.7071067811865475))
        locations['2'] = Pose(Point(5.19093364016215, -5.869999905675649, 0),
                              Quaternion(0, 0, 1, 6.123233995736766e-17))
